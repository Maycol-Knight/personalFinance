...
const totalIngresos = registrosIniciales.reduce((total, registro) => {
...
const totalGastos = registrosIniciales.reduce((total, registro) => {
...
const balanceAcumulado = totalIngresos - totalGastos;
